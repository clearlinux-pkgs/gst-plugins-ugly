...
Source0  : https://gstreamer.freedesktop.org/src/gst-plugins-ugly/gst-plugins-ugly-1.24.3.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-plugins-ugly/gst-plugins-ugly-1.24.3.tar.xz.asc
...
%setup -q -n gst-plugins-ugly-1.24.3
cd %{_builddir}/gst-plugins-ugly-1.24.3
pushd ..
cp -a gst-plugins-ugly-1.24.3 buildavx2
popd
pushd ..
cp -a gst-plugins-ugly-1.24.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714489524
