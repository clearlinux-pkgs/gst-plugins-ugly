...
Source0  : https://gstreamer.freedesktop.org/src/gst-plugins-ugly/gst-plugins-ugly-1.24.12.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-plugins-ugly/gst-plugins-ugly-1.24.12.tar.xz.asc
...
%setup -q -n gst-plugins-ugly-1.24.12
cd %{_builddir}/gst-plugins-ugly-1.24.12
pushd ..
cp -a gst-plugins-ugly-1.24.12 buildavx2
popd
pushd ..
cp -a gst-plugins-ugly-1.24.12 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738196555
